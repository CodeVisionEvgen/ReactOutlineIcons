...
export const AirplayIcon: React.FC<IconSvgProps> = ({ ...props }) => (
  <svg width={props.size || 22} height={props.size || 22} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CloudIcon: React.FC<IconSvgProps> = ({ ...props }) => (
  <svg width={props.size || 22} height={props.size || 22} viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
